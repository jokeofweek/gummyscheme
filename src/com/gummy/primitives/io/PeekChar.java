...
/**
 * This primitive IO procedure peeks a Scheme character from an input port.
 * 
 * @author Dominic Charley-Roy
 * 
 */
public class PeekChar extends Procedure {
	...
	public Object apply(Environment environment, List<Object> arguments) {
		try {
			return Reader.peekChar(Marshall.getInputPort(Expression.eval(
					arguments.get(0), environment)));
		} catch (IOException e) {
			throw new InterpreterException("Could not peek character - "
					+ e.getMessage());
		}
	}
